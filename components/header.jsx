      ...
      <div className="flex justify-between p-6 pt-8 items-center">
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            target="_blank"
            className="hover:bg-orange-400 rounded-full p-2"
          >
            <Image
              src={"/leetcode.png"}
              width={"20"}
          ...
          <a
            href="https://www.instagram.com/sharma.krishna.00/"
            target="_blank"
            className="hover:bg-gradient-to-r hover:from-[#833ab4] hover:via-[#fd1d1d] hover:to-[#fcb045] rounded-full p-2"
          >
            <Image
              src={"/instagram.png"}
              width={"20"}
          ...
          <a
            ...
            target="_blank"
            className="hover:bg-[#202020] rounded-full p-2"
          >
            <Image
              src={"/github.png"}
              width={"20"}
          ...
          <a
            ...
            target="_blank"
            className="hover:bg-sky-700 rounded-full p-2"
          >
            <Image
              src={"/linkedin.png"}
              width={"20"}
